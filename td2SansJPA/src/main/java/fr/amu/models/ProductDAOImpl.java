...
@Transactional //Evite de gerer les transactions
@Repository //Indique à Spring qu'il s'agit d'un accès bd
public class ProductDAOImpl implements ProductDAO {
	...
	public Integer add(Product product) {
		...
		// une fois l'update faite on récupère les valeurs grâce à la hashmap de
		// .getKeys().
	...
	public void update(Product product) {
		// nous n'avonspas implémenté la modification d'un produit dans la vue donc ce
