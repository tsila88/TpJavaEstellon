...
public class ProductControllerTests {
	...
	@Autowired
	MockMvc mvc; // Permet pelin d'accès à l'url méthodes
	
	@MockBean 
	ProductService ps; //Instance factice d'une classe java qui va permettre d'éviter que la méthode testée signale un manque

	@Before
	public void setup() {//Indique le contexte soit dire là ou se trouvent les jsp
	...
	@Test
	public void add() throws Exception {//Test d'une méthode qui retorune une vue
