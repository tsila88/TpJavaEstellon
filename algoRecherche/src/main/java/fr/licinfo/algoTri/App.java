...
import fr.licinfo.algoRecherche.algoRecherche;
import fr.licinfo.algoTri.AlgoTri;
...
public class App 
{
    public static void main( String[] args )
    {
       ...
       // algotri.triRapide(tabAtrier);
        //algoRecherche.affichageDichotomie(2000,tabAtrier);
        //algoRecherche.affichageDichotomie(45,tabAtrier);
        
        algoRecherche.verifeIncrementation();
