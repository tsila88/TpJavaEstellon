...
<body>
		...
		<div class="container">
			...
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/food/favorites"> <i
						class="fas fa-star"></i> Favorites
				</a></li>
			</ul>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<form id="typeselectform"
					action="${pageContext.request.contextPath}/food/type" method="POST">
					<div class="form-group">
						<label for="categoryselect">Filter by Food Type:</label> <select
							...
							<c:forEach var="food" items="${foods}">
								<li class="list-group-item" id="${food.id}">
									...
									<div class="row">
										...
										<div class="col">
											<form action="${pageContext.request.contextPath}/food/favori"
												method="POST">
												<input type="hidden" value="${food.id}" name="foodId" />
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="addfoodform"
									...
									<div class="form-group">
										<label for="brandinput">Brand:</label> <input type="text"
											class="form-control" id="brandinput" name="brand"></input>
									</div>
		...
		if (foodcount) {
			...
			var myChart = new Chart(ctx, {
				...
				data : {
					...
					datasets : [ {
						label : '# of Votes',
						data : [ foodcount.EXCELLENT, foodcount.GOOD,
								foodcount.MEDIOCRE, foodcount.BAD ],
						backgroundColor : [ 'rgba(0, 255, 0, 1)',
								'rgba(0, 153, 51, 1)', 'rgba(255, 102, 0, 1)',
								'rgba(204, 0, 0, 1)' ],
			...
			console
					.log("Il manque les données de nombre par qualité pour le graphique !");
		}
	</script>
